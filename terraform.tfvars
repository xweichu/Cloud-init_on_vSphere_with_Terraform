...
# ips = [
#   [{ipv4_address="172.16.22.95",ipv4_netmask="23"}],
#   [{ipv4_address="172.16.22.96",ipv4_netmask="23"}]
# ]

ipv4_gateway = "172.16.23.253"
dns_servers = ["172.16.16.16","172.16.16.17"]

# configure either or both password and ssh_authorization_key for the OS, otherwise VMs are not accessible.
# password is in plain text here, it will be encrypted using hash functions. Once the env is deployed,  remove the pswd value from this config file to keep it safe.
